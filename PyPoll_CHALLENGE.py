...
with open(file_to_save, "w") as txt_file:
    ...
    # 6f: Write an if statement to determine the winning county and get its vote count.
        if (county > largest_county) and (county_percentage > largest_county_percentage):
    ...
    largest_county_summary = (
        f"\n-------------------------\n"
        f"Largest County Turnout: {largest_county_candidate}\n"
        f"-------------------------\n\n"
        f"Votes Garnered by Each Candidate:\n")
